...
% U1a_real=zeros(2*L);
% U1a_real(1,L)=1/2;
% U1a_real(L+1,2*L)=-1/2;
% U1a_real=U1a_real-U1a_real.';
% U1a_real=U1a_real*sqrt(gamt);
% 
% 
% U1a_imag=zeros(2*L);
% U1a_imag(1,2*L)=-1/2;
% U1a_imag(L+1,L)=-1/2;
% U1a_imag=U1a_imag-U1a_imag.';
% U1a_imag=U1a_imag*sqrt(gamt);
% 
% U2a_real=U1a_real;
% U2a_imag=-U1a_imag;
